...
public class Main implements Serializable {
    ...
    private static SerializableSparkModule sparkModule = new SerializableSparkModule(Constants.kafkaProducer(), Constants.SENDING_TOPIC);
    ...
    private static void process(Tuple2<String, String> record){
